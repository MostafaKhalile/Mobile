...
import 'package:techtime/presentation/components/carousel.dart';
import 'package:techtime/presentation/components/category_card.dart';
import 'package:techtime/presentation/components/company_card.dart';
import 'package:techtime/presentation/utils/custom_snackbar.dart';
...
class _ClientHomeScreenState extends State<ClientHomeScreen> {
            ...
            child: GlowingOverscrollIndicator(
              ...
              child: BlocConsumer<CategoriesBloc, CategoriesState>(
                ...
                if (state is CategoriesLoading || state is CategoriesInitial) {
                  ...
                  return buildCategoriessData(state);
  ...
  ListView buildCategoriessData(CategoriesLoaded state) {
    return ListView.builder(
      shrinkWrap: true,
      scrollDirection: Axis.horizontal,
